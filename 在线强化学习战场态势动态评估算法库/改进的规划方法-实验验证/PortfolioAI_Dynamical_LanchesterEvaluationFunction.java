...
import ai.evaluation.Dynamical_LanchesterEvaluationFunction;
 ...
 * @author santi
 */
public class PortfolioAI_Dynamical_LanchesterEvaluationFunction extends AIWithComputationBudget implements InterruptibleAI {
    ...
    public PortfolioAI_Dynamical_LanchesterEvaluationFunction(UnitTypeTable utt) {
        this(new AI[]{new WorkerRush(utt),
             ...
             100, -1, 100,
             new Dynamical_LanchesterEvaluationFunction());
    }
    
    
    public PortfolioAI_Dynamical_LanchesterEvaluationFunction(AI s[], boolean d[], int time, int max_playouts, int la, EvaluationFunction e) {
    ...
    public PlayerAction getBestActionSoFar() throws Exception {
        int n = strategies.length;
        if (DEBUG>=1) {
            System.out.println("PortfolioAI_Dynamical_LanchesterEvaluationFunction, game cycle: " + gs_to_start_from.getTime());
        ...
        if (DEBUG>=1) {
            System.out.println("PortfolioAI_Dynamical_LanchesterEvaluationFunction: selected " + bestMax + "  with score: " + bestMaxScore);
        }
    ...
    @Override
    public AI clone() {
        return new PortfolioAI_Dynamical_LanchesterEvaluationFunction(strategies, deterministic, TIME_BUDGET, ITERATIONS_BUDGET, LOOKAHEAD, evaluation);
    }
    ...
    public List<ParameterSpecification> getParameters() {
        ...
        parameters.add(new ParameterSpecification("EvaluationFunction", EvaluationFunction.class, new Dynamical_LanchesterEvaluationFunction()));
