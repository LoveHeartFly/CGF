...
import ai.evaluation.Dynamical_SimpleEvaluationFunction;
 ...
 * @author santi
 */
public class IDABCD_Dynamical_SimpleEvaluationFunction extends AIWithComputationBudget implements InterruptibleAI {
    ...
    public IDABCD_Dynamical_SimpleEvaluationFunction(UnitTypeTable utt) {
        this(100, -1, 
             new WorkerRush(utt, new AStarPathFinding()), 100, 
             new Dynamical_SimpleEvaluationFunction(), true);
    }

    
    public IDABCD_Dynamical_SimpleEvaluationFunction(int tpc, int ppc, AI a_playoutAI, int a_maxPlayoutTime, EvaluationFunction a_ef, boolean a_performGreedyActionScan) {
        super(tpc, ppc);
    ...
    public AI clone() {
        return new IDABCD_Dynamical_SimpleEvaluationFunction(TIME_BUDGET, ITERATIONS_BUDGET, playoutAI, maxPlayoutTime, ef, performGreedyActionScan);
    }
...
//        System.out.println("searchOutsideStack: stack is not empty.");
    ...
    public List<ParameterSpecification> getParameters()
    {
        ...
        parameters.add(new ParameterSpecification("EvaluationFunction", EvaluationFunction.class, new Dynamical_SimpleEvaluationFunction()));
