 ...
 * @author santi
 */
public class PortfolioAI_Dynamical_SimpleEvaluationFunction extends AIWithComputationBudget implements InterruptibleAI {
    ...
    public PortfolioAI_Dynamical_SimpleEvaluationFunction(UnitTypeTable utt) {
        this(new AI[]{new WorkerRush(utt),
             ...
             100, -1, 100,
             new Dynamical_SimpleEvaluationFunction());
    }
    
    
    public PortfolioAI_Dynamical_SimpleEvaluationFunction(AI s[], boolean d[], int time, int max_playouts, int la, EvaluationFunction e) {
    ...
    @Override
    public AI clone() {
        return new PortfolioAI_Dynamical_SimpleEvaluationFunction(strategies, deterministic, TIME_BUDGET, ITERATIONS_BUDGET, LOOKAHEAD, evaluation);
    }
