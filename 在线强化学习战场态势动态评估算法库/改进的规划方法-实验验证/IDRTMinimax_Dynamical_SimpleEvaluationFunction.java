 ...
 * @author santi
 */
public class IDRTMinimax_Dynamical_SimpleEvaluationFunction extends AIWithComputationBudget implements InterruptibleAI {
    ...
    public IDRTMinimax_Dynamical_SimpleEvaluationFunction(UnitTypeTable utt) {
        this(100, new Dynamical_SimpleEvaluationFunction());
    }

    
    public IDRTMinimax_Dynamical_SimpleEvaluationFunction(int available_time, EvaluationFunction a_ef) {
    ...
    @Override
    public AI clone() {
        return new IDRTMinimax_Dynamical_SimpleEvaluationFunction(TIME_BUDGET, ef);
    }  
