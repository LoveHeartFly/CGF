 ...
 * @author santi
 */
public class IDRTMinimax_Dynamical_LanchesterEvaluationFunction extends AIWithComputationBudget implements InterruptibleAI {
    ...
    public IDRTMinimax_Dynamical_LanchesterEvaluationFunction(UnitTypeTable utt) {
        this(100, new Dynamical_LanchesterEvaluationFunction());
    }

    
    public IDRTMinimax_Dynamical_LanchesterEvaluationFunction(int available_time, EvaluationFunction a_ef) {
    ...
    @Override
    public AI clone() {
        return new IDRTMinimax_Dynamical_LanchesterEvaluationFunction(TIME_BUDGET, ef);
    }  
