 ...
 * @author santi
 */
public class IDRTMinimax_Dynamical_SimpleSqrtEvaluationFunction extends AIWithComputationBudget implements InterruptibleAI {
    ...
    public IDRTMinimax_Dynamical_SimpleSqrtEvaluationFunction(UnitTypeTable utt) {
        this(100, new Dynamical_SimpleSqrtEvaluationFunction());
    }

    
    public IDRTMinimax_Dynamical_SimpleSqrtEvaluationFunction(int available_time, EvaluationFunction a_ef) {
    ...
    @Override
    public AI clone() {
        return new IDRTMinimax_Dynamical_SimpleSqrtEvaluationFunction(TIME_BUDGET, ef);
    }  
