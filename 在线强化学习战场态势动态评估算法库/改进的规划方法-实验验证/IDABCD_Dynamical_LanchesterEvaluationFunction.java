 ...
 * @author santi
 */
public class IDABCD_Dynamical_LanchesterEvaluationFunction extends AIWithComputationBudget implements InterruptibleAI {
    ...
    public IDABCD_Dynamical_LanchesterEvaluationFunction(UnitTypeTable utt) {
        this(100, -1, 
             new WorkerRush(utt, new AStarPathFinding()), 100, 
             new Dynamical_LanchesterEvaluationFunction(), true);
    }

    
    public IDABCD_Dynamical_LanchesterEvaluationFunction(int tpc, int ppc, AI a_playoutAI, int a_maxPlayoutTime, EvaluationFunction a_ef, boolean a_performGreedyActionScan) {
        super(tpc, ppc);
    ...
    public AI clone() {
        return new IDABCD_Dynamical_LanchesterEvaluationFunction(TIME_BUDGET, ITERATIONS_BUDGET, playoutAI, maxPlayoutTime, ef, performGreedyActionScan);
    }
