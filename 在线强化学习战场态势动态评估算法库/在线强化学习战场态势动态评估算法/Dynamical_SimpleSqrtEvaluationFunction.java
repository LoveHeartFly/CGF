...
/**
 * Dynamical_SimpleSqrtEvaluationFunction class to evaluate game states and log results to files.
 * Each method call logs the score in a file named after the method in the ./results/ directory.
 */
public class Dynamical_SimpleSqrtEvaluationFunction extends EvaluationFunction {
    ...
    public Dynamical_SimpleSqrtEvaluationFunction() {
        // 初始化权重值
        RESOURCE = 20f;
    ...
    private void logEvaluationTime(long duration) {
        try {
            File file = new File("./results/Dynamical_SimpleSqrtEvaluationFunction.txt");
